...
public class Normal_Zombie extends Zom{
    ...
    static {
        File file = new File("src/main/resources/images/Normal_Walk.gif");
        image_walk = new Image(file.toURI().toString());
        file = new File("src/main/resources/images/Normal_Attack.gif");
    ...
    public Normal_Zombie(int r, double c, AnchorPane pane){
        super(r, c, 50, 2, pane);
